...
func parseHexRgb(c string) Color {
	return NewRgba(
		ehex.ParseSingleHex(rune(c[0]))*16+ehex.ParseSingleHex(rune(c[0])),
		ehex.ParseSingleHex(rune(c[1]))*16+ehex.ParseSingleHex(rune(c[1])),
		ehex.ParseSingleHex(rune(c[2]))*16+ehex.ParseSingleHex(rune(c[2])),
		255,
	)
}
...
func parseHexRgba(c string) Color {
	return NewRgba(
		...
		ehex.ParseSingleHex(rune(c[1]))*16+ehex.ParseSingleHex(rune(c[1])),
		ehex.ParseSingleHex(rune(c[2]))*16+ehex.ParseSingleHex(rune(c[2])),
		ehex.ParseSingleHex(rune(c[3]))*16+ehex.ParseSingleHex(rune(c[3])),
	)
}

func parseHexRrGgBb(c string) Color {
	return NewRgba(
		ehex.ParseSingleHex(rune(c[0]))*16+ehex.ParseSingleHex(rune(c[1])),
		ehex.ParseSingleHex(rune(c[2]))*16+ehex.ParseSingleHex(rune(c[3])),
		ehex.ParseSingleHex(rune(c[4]))*16+ehex.ParseSingleHex(rune(c[5])),
		255,
	)
}
...
func parseHexRrGgBbAa(c string) Color {
	return NewRgba(
		...
		ehex.ParseSingleHex(rune(c[2]))*16+ehex.ParseSingleHex(rune(c[3])),
		ehex.ParseSingleHex(rune(c[4]))*16+ehex.ParseSingleHex(rune(c[5])),
		ehex.ParseSingleHex(rune(c[6]))*16+ehex.ParseSingleHex(rune(c[7])),
	)
}
